...
export default function AboutMe() {
  ...
  useLayoutEffect(() => {
    if (index === 1 && prevIndex === 0) {
      animate([
        ...
        [
          ".path-strokes",
          { pathLength: [0, 1] },
          { duration: 3, ease: "easeInOut", at: "-1.5" },
        ],
        [
          ".stroke",
    ...
    } else if (index === 1 && prevIndex === 2) {
      animate([
        [
          ".outer-container",
          { y: [-100, 0], opacity: [0, 1] },
          { duration: 1.5, type: "spring", ease: "easeInOut" },
        ],
        [
          ".path-strokes",
          { pathLength: [0, 1] },
          { duration: 2.5, ease: "easeInOut", at: "-2" },
        ],
        [
          ".stroke",
          { width: ["0%", "100%"], opacity: [0, 1] },
  ...
  return (
    <div className="relative bg-black/90 overflow-hidden w-screen h-screen flex flex-col items-center">
      ...
      <div className="w-full h-full min-w-[1980px] min-h-[1024px] absolute top-0 left-0">
        ...
        <div className="slide background w-[400%] h-[250%] bg-teal-600 absolute z-0"></div>
      </div>
    </div>
  );
}
